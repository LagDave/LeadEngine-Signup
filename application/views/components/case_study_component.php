...
<div class="header"'>
        ...
        <div class="container">
            <img src="http://leadengine.live/home/assets/images/wide_logo_white.png" alt="">
...
<p class="text-montserrat text-grey text-mednorm text-center">This case study shows results from a Prospect
    Engine lender client over a 30-day period.</p>
<br><br>
<div class="cs-con1">
    ...
    <div class="cs-con1-img">
        ...
        <img src="http://leadengine.live/home/assets/images/case_study.PNG" alt="">
...
<div class="container">
    ...
    <div class="testimonial">
        ...
        <img src="http://leadengine.live/home/assets/images/person1.jpg" class='testimonial-profile' alt="">
    ...
    <div class="testimonial">
        ...
        <img src="http://leadengine.live/home/assets/images/person3.jpg" class='testimonial-profile' alt="">
        <p class="text-mednorm"><i class="text-blue fas fa-quote-right"></i></p>

        <p class="text-grey text-normal text-center text-montserrat">
            Excellent service and results! I never thought that there would be a simple process like LeadEngine.
            I don’t need to
